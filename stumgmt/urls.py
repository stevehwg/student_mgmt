...
urlpatterns = [
	...
	url(r'^teacher_lesson/$', views.teacher_lesson, name='teacher_lesson'),
	url(r'^teacher_lesson/(?P<pk>[0-9]+)/$', views.teacher_lesson, name='new_teacher_lesson'),
	url(r'^student_lesson/$', views.student_lesson, name='student_lesson'),
	url(r'^student_lesson/(?P<pk>[0-9]+)/$', views.student_lesson, name='new_student_lesson'),
